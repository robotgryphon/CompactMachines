...
public abstract class CompactDimension {
    public static final ResourceKey<Level> LEVEL_KEY = ResourceKey
            .create(Registries.DIMENSION, CompactMachines.identifier("compact_world"));

    public static final ResourceKey<DimensionType> DIM_TYPE_KEY = ResourceKey
            .create(Registries.DIMENSION_TYPE, CompactMachines.identifier("compact_world"));

    public static final Identifier COMPACT_BIOME = CompactMachines.identifier("machine");
