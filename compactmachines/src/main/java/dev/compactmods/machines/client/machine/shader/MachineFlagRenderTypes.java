...
/**
 * Holds one compiled {@link RenderType} per registered {@link FlagShader}.
 *
...
public final class MachineFlagRenderTypes {
    ...
    public static void registerAll(RegisterRenderPipelinesEvent event) {
        BY_FLAG_ID.clear();
//        for (FlagShader flag : MachineFlags.all()) {
...
//        }
     ...
     * </ul>
     */
//    private static RenderPipeline buildPipeline(FlagShader flag) {
